...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function addGroup() {
      ...
      // atualiza nomes/id dos campos usando prefixo
      this.updateFields(template);
      this.groupsWrapperTarget.appendChild(template);
    }
  }, {
    key: "removeGroup",
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", this.clearComponents(group));
            case 4:
    ...
    value: function () {
      var _loadLectures = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var group, wombId, componentId, url, data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              group = event.target.closest('[data-lesson-target="group"]');
              wombId = group.querySelector('[data-lesson-target="wombSelect"]').value;
              componentId = event.target.value;
              if (!(!wombId || !componentId)) {
                _context2.next = 5;
                break;
              }
              return _context2.abrupt("return", this.clearLectures(group));
            case 5:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              group = event.target.closest('[data-lesson-target="group"]');
              wombId = group.querySelector('[data-lesson-target="wombSelect"]').value;
              componentId = group.querySelector('[data-lesson-target="componentSelect"]').value;
              lectureId = event.target.value;
              if (!(!wombId || !componentId || !lectureId)) {
                _context3.next = 6;
                break;
              }
              return _context3.abrupt("return", this.clearVideos(group));
            case 6:
            ...
            case 9:
              data = _context3.sent;
              this.renderCheckboxes(group, data);
            case 11:
            case "end":
    ...
    key: "updateFields",
    value: function updateFields(fragment) {
      var prefix = this.prefixValue;
      fragment.querySelectorAll('select, input').forEach(function (element) {
        if (element.name) element.name = element.name.replace('lesson[...]', prefix);
        if (element.id) element.id = "".concat(element.id, "-").concat(Date.now());
      });
    }
  }, {
    key: "fetchJSON",
    ...
    key: "clearComponents",
    value: function clearComponents(group) {
      if (!group) return;
      var componentSelect = group.querySelector('[data-lesson-target="componentSelect"]');
      if (componentSelect) this.populateSelect(componentSelect, [], {
    ...
    key: "clearLectures",
    value: function clearLectures(group) {
      if (!group) return;
      var lectureSelect = group.querySelector('[data-lesson-target="lectureSelect"]');
      if (lectureSelect) this.populateSelect(lectureSelect, [], {
        defaultOption: "Selecione um módulo"
      });
      this.clearVideos(group);
    }
    ...
    key: "clearVideos",
    value: function clearVideos(group) {
      if (!group) return;
      var videosWrapper = group.querySelector('[data-lesson-target="videosWrapper"]');
      if (videosWrapper) videosWrapper.innerHTML = "<strong class='ms-2'>Selecione uma aula</strong>";
    }
  }, {
    key: "renderCheckboxes",
    value: function renderCheckboxes(group, lectureVideos) {
      var _this = this;
      var wrapper = group.querySelector('[data-lesson-target="videosWrapper"]');
      if (!wrapper) return;
      if (!lectureVideos.length) {
        wrapper.innerHTML = "<strong class='ms-2'>Essa aula não possui vídeos</strong>";
        return;
      }
      var div = document.createElement("div");
      div.className = "row";
      lectureVideos.forEach(function (video) {
        ...
        // nome depende do prefixo: revisão usa videos[], demais usam lecture_video_ids[]
        var fieldName = _this.prefixValue.includes("review") ? "".concat(_this.prefixValue, "[][videos][]") : "".concat(_this.prefixValue, "[][lecture_video_ids][]");
...
_default.targets = ["groupsWrapper", "group", "wombSelect", "componentWrapper", "lectureWrapper", "videosWrapper"];
_default.values = {
  prefix: String,
...
/******/ });
//# sourceMappingURL=application-b30b36fe43e19634c218.js.map