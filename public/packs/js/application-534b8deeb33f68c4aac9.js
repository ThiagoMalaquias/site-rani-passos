...
function _inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && _setPrototypeOf(t, e); }
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
var SidenavController = /*#__PURE__*/function (_ApplicationControlle) {
  function SidenavController() {
    _classCallCheck(this, SidenavController);
    return _callSuper(this, SidenavController, arguments);
  }
  _inherits(SidenavController, _ApplicationControlle);
  return _createClass(SidenavController, [{
    key: "connect",
    value: function connect() {
    ...
    value: function setupEventListeners() {
      ...
      this.htmlTarget.addEventListener("click", function (e) {
        if (_this.bodyTarget.classList.contains('g-sidenav-pinned') && !e.target.classList.contains('sidenav-toggler-line')) {
          _this.bodyTarget.classList.remove(_this.className);
        }
      });
    }
  }, {
    ...
    value: function toggle() {
      var _this2 = this;
      if (this.bodyTarget.classList.contains(this.className)) {
        this.bodyTarget.classList.remove(this.className);
        setTimeout(function () {
          _this2.sidenavTarget.classList.remove('bg-white');
        }, 100);
        this.sidenavTarget.classList.remove('bg-transparent');
      } else {
        this.bodyTarget.classList.add(this.className);
        this.sidenavTarget.classList.add('bg-white');
        this.sidenavTarget.classList.remove('bg-transparent');
      }
    }
  }]);
}(ApplicationController);
SidenavController.targets = ["sidenav", "body", "html"];
/* harmony default export */ __webpack_exports__["default"] = (SidenavController);
...
/******/ });
//# sourceMappingURL=application-534b8deeb33f68c4aac9.js.map