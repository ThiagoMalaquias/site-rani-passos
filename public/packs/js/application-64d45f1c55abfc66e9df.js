...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function log() {
      ...
      if (this.debugValue) (_console = console).log.apply(_console, ["[exit-intent]"].concat(args));
    }
  }, {
    key: "connect",
    value: function connect() {
      this.$ = window.jQuery || window.$;
      this.log("connect; jQuery?", !!this.$);
      if (!this.$) {
        this.log("jQuery ausente");
        return;
      }
      try {
        ...
        this.log("bootstrap modal preparado; plugin?", !!this.$.fn.modal);
      } catch (e) {
        this.log("erro preparando modal", e);
        return;
      }
      if (this.showOnceKeyModalDiscountValue == 1 || sessionStorage.getItem(this.showOnceKeyModalDiscountValue) == "1") {
        sessionStorage.setItem(this.showOnceKeyModalDiscountValue, "1");
      } else {
      ...
      this.log("listeners instalados; threshold:", this.thresholdValue);
    }
  }, {
    key: "disconnect",
    ...
    value: function handleMouseMove(e) {
      ...
      if (e.clientY <= this.thresholdValue) {
        this.log("trigger por mousemove no topo", e.clientY);
        this.showOnce();
      }
    }
  }, {
    ...
    value: function handleMouseLeave() {
      if (Date.now() < this.readyAt) return;
      this.log("trigger por mouseleave na janela");
      this.showOnce();
    }
  }, {
    ...
    value: function handleVisibilityChange() {
      ...
      // opcional: if (document.visibilityState === "hidden") this.showOnce()
    }
  }, {
    key: "showOnce",
    value: function showOnce() {
      ...
      var open = function open() {
        _this.log("abrindo modal…");
        _this.$(_this.element).one("shown.bs.modal", function () {
          return _this.log("evento shown.bs.modal disparado");
        });
        _this.$(_this.element).one("hidden.bs.modal", function () {
          return _this.log("evento hidden.bs.modal disparado");
        });
        _this.$(_this.element).modal("show");
      };
    ...
    value: function close(e) {
      ...
      if (this.$) this.$(this.element).modal("hide");
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
_default.values = {
...
/******/ });
//# sourceMappingURL=application-64d45f1c55abfc66e9df.js.map