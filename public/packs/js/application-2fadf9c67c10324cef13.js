...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function displayInstallments() {
      ...
      installmentSelect.innerHTML = this.installments.map(function (_ref) {
        var key = _ref.key,
          value = _ref.value;
        if (key < 7) {
          return "<option value=\"".concat(key, "\" data-js-installment-value=\"").concat(value, "\">").concat(key, " x de R$ ").concat(_this.valorPtBr(value), "</option>");
        } else {
          return "<option value=\"".concat(key, "\" data-js-installment-value=\"").concat(value, "\">").concat(key, " x de R$ ").concat(_this.valorPtBr(value), "*</option>");
        }
      }).join("");
    ...
    value: function setInstallment(event) {
      ...
      var perInstallment = parseFloat(perInstallmentStr.replace(/\./g, "").replace(",", ".")) || 0;
      var total = installments * perInstallment;
      var totalAmountEl = document.getElementById("total_amount");
      if (!totalAmountEl) return;
      totalAmountEl.textContent = "R$ ".concat(total.toFixed(2).replace(".", ","));
...
/******/ });
//# sourceMappingURL=application-2fadf9c67c10324cef13.js.map