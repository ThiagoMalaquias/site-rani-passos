...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function search() {
      ...
      // Atualiza o parâmetro de busca na URL
      if (query.trim() === "") {
      ...
      fetch(url, {
        ...
        // Extrai apenas o grid de resultados
        var newResults = doc.getElementById("help-centers-grid");
        if (newResults) {
          _this2.resultsTarget.innerHTML = newResults.innerHTML;
        }
...
/******/ });
//# sourceMappingURL=application-a0a77217881000176813.js.map