...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function search() {
      ...
      fetch("/admin/help_centers.json?search=" + query).then(function (response) {
        return response.json();
      }).then(function (data) {
        if (newResults) {
          _this2.resultsTarget.innerHTML = data.html;
        }
...
/******/ });
//# sourceMappingURL=application-adac6cef87a251aa24e5.js.map