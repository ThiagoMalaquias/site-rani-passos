...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      ...
      // liga handlers para controlar o vídeo
    ...
    value: function _loadVideo() {
      ...
      // - nocookie: privacidade
      // - autoplay=1 (pode exigir muted p/ auto-start)
      // - mute=1 (melhor compatibilidade)
      // - playsinline=1 (iOS)
      // - rel=0, modestbranding=1 para ficar “limpo”
      var params = new URLSearchParams({
        autoplay: "1",
        mute: this.autoplayMutedValue ? "1" : "0",
        rel: "0",
        modestbranding: "1",
        playsinline: "1",
        iv_load_policy: "3",
      ...
      // se já estiver igual, não reinjeta
...
/******/ });
//# sourceMappingURL=application-744f2b724a3b223aaed7.js.map