...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "setValueImutable",
    value: function setValueImutable() {
      var totalAmount = document.getElementById("total_amount_imutable").textContent;
      var installments = document.getElementById("installments").value;
      var totalAmountFloat = this.valorFloat(totalAmount);
      var cashbackApplied = document.getElementById("cashback_applied").value;
      var cashbackValueFloat = parseFloat(cashbackApplied || 0);
      var totalAmountWithCashback = totalAmountFloat - cashbackValueFloat;
      if (installments && +installments > 1) {
        document.getElementById("total_amount").innerHTML = this.valorPtBr(totalAmountWithCashback);
        document.getElementById("installments").value = 1;
      }
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-698b4af6080314c4c22d.js.map