...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              maxCashbackFloat = parseFloat(maxCashback.replace("R$", "").replace(".", "").replace(",", "."));
              cashbackInput = document.getElementById("cashback_to_use");
              cashbackValue = cashbackInput.value;
              cashbackValueFloat = parseFloat(cashbackValue.replace(",", "."));
              totalAmount = document.getElementById("total_amount").textContent;
              totalAmountFloat = parseFloat(totalAmount.replace("R$", "").replace(".", "").replace(",", "."));
            ...
            case 11:
              ...
              return _context.abrupt("return");
            case 14:
              if (!(totalAmountWithCashback > maxCashbackFloat)) {
                _context.next = 17;
                break;
              }
    ...
    value: function setInstallment(event) {
      ...
      if (!divPrice) return;
      var price = divPrice.textContent;
      var priceFloat = parseFloat(price.replace(",", "."));
      var priceWithInstallment = priceFloat / installment;
      divPrice.textContent = "R$ ".concat(priceWithInstallment.toFixed(2).replace(".", ","));
    }
  }, {
    ...
    value: function setupFormSubmit() {
      ...
      formPayments.addEventListener("submit", function (e) {
        ...
        if (!pillsOption) {
          _this.swalError("Selecione uma forma de pagamento");
          return;
        }
        ...
        if (method === "card") {
          ...
          if (!number || !name || !expiry || !cvc || !exp_month || !exp_year) {
            _this.swalError("Tivemos um Problema ao validar seu cartão. Entre em contato com o suporte");
            return;
          }
...
/******/ });
//# sourceMappingURL=application-7eff42154aadecf686ac.js.map