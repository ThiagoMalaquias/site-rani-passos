  ...
  return _createClass(_default, [{
    ...
    value: function adjustNames(fragment) {
      ...
      fragment.querySelectorAll("select, input").forEach(function (element) {
        if (element.name) {
          ...
          element.name = element.name.replace("lesson[", "".concat(_this.prefixValue, "["));
        }
        if (element.id) {
          element.id = "".concat(element.id, "_").concat(groupId);
        }
    ...
    value: function renderVideos(group, videos) {
      ...
      videos.forEach(function (video) {
        ...
        if (_this2.prefixValue.includes("review")) {
...
/******/ });
//# sourceMappingURL=application-537a70829b5b7e0ce4ca.js.map