...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "applyCashbackValue",
    value: function () {
      var _applyCashbackValue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var maxCashback, maxCashbackFloat, cashbackInput, cashbackValue, cashbackValueFloat, totalAmount, totalAmountFloat, totalAmountWithCashback, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              maxCashback = document.getElementById("max_cashback").textContent;
              maxCashbackFloat = this.valorFloat(maxCashback);
              cashbackInput = document.getElementById("cashback_to_use");
              cashbackValue = cashbackInput.value;
              cashbackValueFloat = this.valorFloat(cashbackValue);
              totalAmount = document.getElementById("total_amount_imutable").textContent;
              totalAmountFloat = this.valorFloat(totalAmount);
              totalAmountWithCashback = totalAmountFloat - cashbackValueFloat;
              ...
              return _context.abrupt("return");
            case 11:
              if (!(cashbackValueFloat == 0)) {
                _context.next = 14;
                break;
              }
              this.swalError("O valor do cashback não pode ser 0");
              return _context.abrupt("return");
            case 14:
              ...
              this.swalError("O valor do cashback n\xE3o pode ser maior que o saldo dispon\xEDvel: R$ ".concat(this.valorPtBr(maxCashbackFloat)));
              return _context.abrupt("return");
            case 17:
              _context.next = 19;
              return fetch("/cart/all_installments?total_with_cashback=".concat(totalAmountWithCashback));
            case 19:
              response = _context.sent;
              _context.next = 22;
              return response.json();
            case 22:
              ...
              document.getElementById("total_amount").innerHTML = "R$ ".concat(this.valorPtBr(totalAmountWithCashback));
      ...
      function applyCashbackValue() {
        return _applyCashbackValue.apply(this, arguments);
      }
      return applyCashbackValue;
    }()
  }, {
    key: "displayInstallments",
    value: function displayInstallments() {
      var _this = this;
      var installmentSelect = document.getElementById("installment");
      if (!installmentSelect) return;
      installmentSelect.innerHTML = this.installments.map(function (_ref) {
        var key = _ref.key,
          value = _ref.value;
        if (key < 7) {
          return "<option value=\"".concat(key, "\" data-js-installment-value=\"").concat(value, "\">").concat(key, " x de ").concat(_this.valorPtBr(value), "</option>");
        } else {
          return "<option value=\"".concat(key, "\" data-js-installment-value=\"").concat(value, "\">").concat(key, " x de ").concat(_this.valorPtBr(value), "*</option>");
        }
      }).join("");
    ...
    key: "setInstallment",
    value: function setInstallment(event) {
      var select = event.target;
      var option = select.selectedOptions[0];
      if (!option) return;
      var installments = parseInt(option.value, 10) || 1;
      var perInstallmentStr = option.dataset.jsInstallmentValue || "0";
      var perInstallment = parseFloat(perInstallmentStr) || 0;
      var total = installments * perInstallment;
      var totalAmountEl = document.getElementById("total_amount");
      if (!totalAmountEl) return;
      totalAmountEl.textContent = "".concat(this.valorPtBr(total));
    ...
    value: function setupFormSubmit() {
      ...
      formPayments.addEventListener("submit", function (e) {
        ...
        if (!pillsOption) {
          _this2.swalError("Selecione uma forma de pagamento");
          return;
        }
        ...
        if (method === "card") {
          ...
          if (!number || !name || !expiry || !cvc || !exp_month || !exp_year) {
            _this2.swalError("Tivemos um Problema ao validar seu cartão. Entre em contato com o suporte");
            return;
          }
    ...
    key: "valorFloat",
    value: function valorFloat(valor) {
      return parseFloat(valor.replace("R$", "").replace(".", "").replace(",", "."));
    }
  }, {
    key: "valorPtBr",
    value: function valorPtBr(valor) {
      return valor.toLocaleString('pt-BR', {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
      });
...
/******/ });
//# sourceMappingURL=application-ad984aa193df0edc059e.js.map