...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    key: "connect",
    value: function connect() {
      console.log("ExitIntentController connected");
      // não repita se já mostramos na sessão
      if (sessionStorage.getItem(this.showOnceKey)) return;
      ...
      // Evite disparar logo que a página carrega (p.ex. 2s de “graça”)
    ...
    value: function handleMouseMove(e) {
      ...
      // se o ponteiro subiu para a região do topo, consideramos “saída”
    ...
    value: function handleMouseLeave(e) {
      if (Date.now() < this.readyAt) return;
      // mouse saiu pela parte superior da janela (comum ao ir fechar aba)
      // alguns browsers não dão coordenadas aqui; usamos mousemove como principal.
      this.showOnce();
    }
  }, {
    key: "handleVisibilityChange",
    value: function handleVisibilityChange() {
      // Quando a aba perde visibilidade bem rápido após interação
      if (document.visibilityState === "hidden") {
        // Opcional: só mostrar se já houve alguma interação anterior
        // this.showOnce()
      }
    }
  }, {
...
_default.values = {
  ...
  // margem de “intenção de saída” (px a partir do topo)
  threshold: {
    type: Number,
    "default": 8
  }
...
/******/ });
//# sourceMappingURL=application-fe5bf29f59910cbdb13f.js.map