...
// Se usa bundler (Vite/Webpack): importe a classe Modal diretamente
// import Modal from "bootstrap/js/dist/modal"

// Se usa CDN do <script> no layout, acessamos window.bootstrap
var _default = /*#__PURE__*/function (_Controller) {
  function _default() {
    _classCallCheck(this, _default);
    return _callSuper(this, _default, arguments);
  ...
  return _createClass(_default, [{
    key: "connect",
    value: function connect() {
      // instancia o Bootstrap Modal
      this.modal = this._getBootstrapModal();
      if (!this.modal) return;
      if (sessionStorage.getItem(this.showOnceKeyValue)) return;
      ...
      this.readyAt = Date.now() + 2000; // evita disparo imediatamente ao carregar
    }
  }, {
    key: "disconnect",
    ...
    value: function handleVisibilityChange() {
      // Opcional: se quiser mostrar quando a aba perde visibilidade
      // if (document.visibilityState === "hidden") this.showOnce()
    }
  }, {
    key: "showOnce",
    ...
    key: "_getBootstrapModal",
    value: function _getBootstrapModal() {
      // 1) via bundler: use a import Modal from "bootstrap/js/dist/modal" (descomente import acima)
      // return new Modal(this.element, { backdrop: true, keyboard: true, focus: true })

      // 2) via CDN: usa window.bootstrap.Modal
      if (window.bootstrap && window.bootstrap.Modal) {
        return new window.bootstrap.Modal(this.element, {
          backdrop: true,
          keyboard: true,
          focus: true
        });
      }
      console.warn("Bootstrap Modal não encontrado. Verifique a inclusão do JS.");
      return null;
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
...
/******/ });
//# sourceMappingURL=application-550ab6d32628ddb7d15e.js.map