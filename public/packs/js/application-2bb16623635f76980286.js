...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "getWombs",
    value: function () {
      var _getWombs = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("/admin/wombs", {
                method: 'GET',
                headers: {
      ...
      function getWombs() {
        return _getWombs.apply(this, arguments);
      }
      return getWombs;
    }()
  }, {
    key: "getComponents",
    value: function () {
      var _getComponents = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var groupWombs, lessonWombId, res, components, areaComponent, selectElement;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              groupWombs = e.target.closest('.group-wombs');
              lessonWombId = groupWombs.querySelector("#lesson_womb_id").value;
              _context2.next = 4;
              return fetch("/admin/wombs/".concat(lessonWombId, "/components"), {
                method: 'GET',
                headers: {
                  Accept: 'application/json',
                  'Content-Type': 'application/json'
            ...
            case 8:
              ...
              components = _context2.t0.parse.call(_context2.t0, _context2.t1);
              areaComponent = groupWombs.querySelector("#area-component");
              areaComponent.innerHTML = " ";
              selectElement = this.createSelect(components, "change->lesson#getLectures", "lesson_component_id", "lesson[lesson_womb_component_lectures_attributes][][component_id]");
    ...
    key: "getLectures",
    value: function () {
      var _getLectures = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
        var groupWombs, lessonWombId, lessonComponentId, res, lectures, areaLecture, selectElement;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              groupWombs = e.target.closest('.group-wombs');
              lessonWombId = groupWombs.querySelector("#lesson_womb_id").value;
              lessonComponentId = groupWombs.querySelector("#lesson_component_id").value;
              _context3.next = 5;
              return fetch("/admin/wombs/".concat(lessonWombId, "/components/").concat(lessonComponentId, "/lectures"), {
                method: 'GET',
                headers: {
                  Accept: 'application/json',
                  'Content-Type': 'application/json'
            ...
            case 9:
              ...
              lectures = _context3.t0.parse.call(_context3.t0, _context3.t1);
              areaLecture = groupWombs.querySelector("#area-lecture");
              areaLecture.innerHTML = " ";
              selectElement = this.createSelect(lectures, "change->lesson#getLectureVideos", "lesson_lecture_id", "lesson[lesson_womb_component_lectures_attributes][][lecture_id]");
      ...
      function getLectures(_x2) {
        return _getLectures.apply(this, arguments);
      }
      return getLectures;
    }()
  }, {
    key: "getLectureVideos",
    value: function () {
      var _getLectureVideos = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
        var _this = this;
        var groupWombs, lessonWombId, lessonComponentId, lessonLectureId, res, lectureVideos, areaLectureVideo, strongElement, divRowElement;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              lessonWombId = groupWombs.querySelector("#lesson_womb_id").value;
              lessonComponentId = groupWombs.querySelector("#lesson_component_id").value;
              lessonLectureId = groupWombs.querySelector("#lesson_lecture_id").value;
              _context4.next = 6;
              return fetch("/admin/wombs/".concat(lessonWombId, "/components/").concat(lessonComponentId, "/lectures/").concat(lessonLectureId, "/lecture_videos"), {
                method: 'GET',
                headers: {
                  Accept: 'application/json',
                  'Content-Type': 'application/json'
            ...
            case 10:
              ...
              lectureVideos = _context4.t0.parse.call(_context4.t0, _context4.t1);
              areaLectureVideo = groupWombs.querySelector("#area-lecture-video");
            ...
            case 20:
              divRowElement = document.createElement("div");
              divRowElement.className = "row";
              lectureVideos.forEach(function (lectureVideo) {
                var divColElement = _this.createCheckbox(lectureVideo);
      ...
      function getLectureVideos(_x3) {
        return _getLectureVideos.apply(this, arguments);
      }
      return getLectureVideos;
    }()
  }, {
    key: "createCheckbox",
    value: function createCheckbox(lectureVideo) {
      ...
      inputElement.id = "lecture_video_".concat(lectureVideo.id);
      var labelElement = document.createElement("label");
      labelElement.className = "form-check-label";
      labelElement.textContent = lectureVideo.title;
      labelElement.setAttribute("for", "lecture_video_".concat(lectureVideo.id));
    ...
    key: "createSelect",
    value: function createSelect(options, action, id, name) {
    ...
    key: "newWombs",
    value: function () {
      var _newWombs = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
        var wombs, options;
      ...
      function newWombs(_x4) {
        return _newWombs.apply(this, arguments);
      }
      return newWombs;
    }()
  }, {
    key: "removeGroupWombs",
    value: function removeGroupWombs(e) {
      e.preventDefault();
      var groupWombs = e.target.closest('.group-wombs');
      if (groupWombs) {
        groupWombs.remove();
      }
      this.changePositionWombs();
    ...
    key: "changePositionWombs",
    value: function changePositionWombs() {
      var globalWombs = document.querySelector('.global-wombs');
      var childDivs = globalWombs.children;
      Array.from(childDivs).forEach(function (div, index) {
        div.id = "womb-".concat(index + 1);
      });
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
_default.targets = ["matrixContainer", "reviewContainer", "group", "wombSelect", "componentWrapper", "componentSelect", "lectureWrapper", "lectureSelect", "videosWrapper"];
_default.values = {
  prefix: String,
...
/******/ });
//# sourceMappingURL=application-2bb16623635f76980286.js.map