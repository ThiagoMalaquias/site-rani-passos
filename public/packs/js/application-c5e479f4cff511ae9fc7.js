  ...
  return _createClass(_default, [{
    ...
    value: function () {
      var _applyCashbackValue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var cashbackInput, cashbackValue, cashbackValueFloat, totalAmount, totalAmountFloat, totalAmountWithCashback, response, installments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    value: function displayInstallments(installments) {
      debugger;
      var installmentSelect = document.getElementById("installment");
      if (!installmentSelect) return;
      installmentSelect.innerHTML = installments.map(function (_ref) {
        var key = _ref.key,
          value = _ref.value;
        if (key < 7) {
...
/******/ });
//# sourceMappingURL=application-c5e479f4cff511ae9fc7.js.map