...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function addGroup() {
      ...
      var instance = this.templateTarget.content.cloneNode(true);
      this.adjustNames(instance);
      this.groupsWrapperTarget.appendChild(instance);
    }
  }, {
    key: "removeGroup",
    ...
    value: function renderVideos(group, videos) {
      ...
      videos.forEach(function (video) {
        ...
        var fieldName = _this2.prefixValue.includes("review") ? "".concat(_this2.prefixValue, "[][videos][]") : "".concat(_this2.prefixValue, "[][lecture_video_ids][]");
...
/******/ });
//# sourceMappingURL=application-1163c90b8977f81b2988.js.map