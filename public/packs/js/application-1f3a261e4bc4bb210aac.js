...
/***/ "./app/javascript/controllers/campaign_import_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/campaign_import_controller.js ***!
  \******************************************************************/
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "validateFile",
    value: function validateFile(event) {
    ...
    key: "showFormAndSubmit",
    value: function showFormAndSubmit() {
      var _this = this;
      // Mostra o formulário
    ...
    value: function submitForm(event) {
      ...
      setTimeout(function () {
        _this2.submitButtonTarget.value = _this2.originalButtonText;
        _this2.submitButtonTarget.disabled = false;
      }, 5000);
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
_default.targets = ["form", "fileInput", "submitButton", "importForm"];


/***/ }),

/***/ "./app/javascript/controllers/chat_messages_controller.js":
/*!****************************************************************!*\
  !*** ./app/javascript/controllers/chat_messages_controller.js ***!
  \****************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function scrollToBottom() {
      var messagesContainer = this.element.querySelector('.messages-container');
...
/***/ "./app/javascript/controllers/discount_search_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/discount_search_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.resultsTarget.addEventListener('click', function (e) {
        var item = e.target.closest('.search-result-item');
        if (item) {
          var discountId = item.dataset.discountId;
          var discountTitle = item.dataset.discountTitle;
          var discountValue = item.dataset.discountValue;
          _this.selectDiscount({
            id: discountId,
            title: discountTitle,
            value: discountValue
          });
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("/admin/discounts.json?title=".concat(encodeURIComponent(query), "&active=true"), {
                headers: {
            ...
            case 11:
              ...
              console.error('Erro na busca:', _context.t0);
            case 14:
            case "end":
    ...
    value: function displayResults() {
      ...
      var resultsHtml = this.results.map(function (discount, index) {
        return "\n      <div class=\"search-result-item p-2 border-bottom\" \n           data-discount-id=\"".concat(discount.id, "\" \n           data-discount-title=\"").concat(discount.title, "\"\n           data-discount-value=\"").concat(discount.value, "\"\n           data-index=\"").concat(index, "\"\n           style=\"cursor: pointer;\">\n        <div class=\"fw-bold\">").concat(discount.title, "</div>\n        <div class=\"text-muted small\">").concat(discount.value, "%</div>\n      </div>\n    ");
      }).join('');
    ...
    value: function highlightSelected() {
      var _this3 = this;
      var items = this.resultsTarget.querySelectorAll('.search-result-item');
      items.forEach(function (item, index) {
        if (index === _this3.selectedIndex) {
    ...
    key: "selectDiscount",
    value: function selectDiscount(discount) {
    ...
    key: "loadSelectedDiscounts",
    value: function loadSelectedDiscounts(discounts) {
      var _this4 = this;
      discounts.forEach(function (discount) {
        _this4.selectedDiscounts.add(discount.id);
        _this4.addDiscountToSelected(discount);
      });
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
_default.targets = ["input", "results", "selectedDiscounts", "hiddenField"];
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      ...
      if (!this.$) {
        console.warn("jQuery ausente (necessário p/ Bootstrap 4).");
        return;
      }
      this.$(this.element).modal({
        show: false,
        backdrop: true,
        keyboard: true,
        focus: true
      });
      this.$(this.element).on("shown.bs.modal", function () {
        return _this._loadVideo();
      });
      this.$(this.element).on("hidden.bs.modal", function () {
        return _this._unloadVideo();
      });
    ...
    value: function showOnce() {
      ...
      var open = function open() {
        return _this2.$(_this2.element).modal("show");
      };
    ...
    value: function _loadVideo() {
      var iframe = this.element.querySelector("#exitIntentVideo");
      if (!iframe) return;
      var vid = this.videoIdValue || "wZwRFLIdCf0";
      ...
      var params = new URLSearchParams({
        ...
        mute: "1",
        // autoplay confiável (desmutamos no gesto)
        playsinline: "1",
        // iOS inline
        rel: "0",
        modestbranding: "1",
        ...
        color: "white",
        enablejsapi: "1",
        // necessário p/ postMessage (play/unMute/…)
        origin: window.location.origin // recomendado com youtube-nocookie
      });
      var src = "https://www.youtube-nocookie.com/embed/".concat(vid, "?").concat(params.toString());
      if (iframe.src !== src) iframe.src = src;

      // Gesto do usuário dentro do modal => desmuta e garante o play
      this._bindUnmuteOnce = function (ev) {
        try {
          var msg = function msg(fn) {
            var _iframe$contentWindow;
            var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
            return (_iframe$contentWindow = iframe.contentWindow) === null || _iframe$contentWindow === void 0 ? void 0 : _iframe$contentWindow.postMessage(JSON.stringify({
              event: "command",
              func: fn,
              args: args
            }), "*");
      ...
      this.element.addEventListener("pointerdown", this._bindUnmuteOnce, {
        once: true,
        capture: true
      });
    }
...
/***/ "./app/javascript/controllers/halloween_controller.js":
/*!************************************************************!*\
  !*** ./app/javascript/controllers/halloween_controller.js ***!
  \************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "initializeHalloween",
    value: function initializeHalloween() {
    ...
    key: "addHalloweenDecorations",
    value: function addHalloweenDecorations() {
      // Cantos da tela
    ...
    value: function createDecoration(emoji, className, top, right, bottom, left) {
    ...
    key: "addFloatingElements",
    value: function addFloatingElements() {
      var _this = this;
      this.floatingInterval = setInterval(function () {
        if (Math.random() > 0.6) {
          _this.createFloatingElement();
        }
      }, 2000);
    }
  }, {
    key: "createFloatingElement",
    value: function createFloatingElement() {
      var emojis = ['🎃', '👻', '🦇', '🕷️', '🍬', '💀', '🕸️', '🌙', '⭐'];
      ...
      var sway = (Math.random() - 0.5) * 3;
      var interval = setInterval(function () {
        top += speed;
        left += sway;
        element.style.top = top + 'px';
        element.style.left = left + 'px';
        element.style.transform = "rotate(".concat(top, "deg)");
    ...
    key: "addFlyingBats",
    value: function addFlyingBats() {
      var _this2 = this;
      this.batInterval = setInterval(function () {
        if (Math.random() > 0.7) {
          _this2.createFlyingBat();
        }
      }, 5000);
    }
  }, {
    key: "createFlyingBat",
    value: function createFlyingBat() {
    ...
    key: "addSpiders",
    value: function addSpiders() {
      var _this3 = this;
      this.spiderInterval = setInterval(function () {
        if (Math.random() > 0.8) {
          _this3.createSpider();
        }
      }, 4000);
    ...
    value: function addParticleSystem() {
      var _this4 = this;
      ...
      for (var i = 0; i < 15; i++) {
        setTimeout(function () {
          _this4.createParticle(particlesContainer);
        }, i * 1000);
      }
    ...
    key: "createParticle",
    value: function createParticle(container) {
      var particles = ['✨', '🌟', '⭐', '💫', '🔮'];
    ...
    key: "addHalloweenCursor",
    value: function addHalloweenCursor() {
      var _this5 = this;
      var throttle = 0;
      document.addEventListener('mousemove', function (e) {
        ...
        if (Math.random() > 0.85) {
          _this5.createCursorTrail(e.pageX, e.pageY);
        }
      });
    }
  }, {
    key: "createCursorTrail",
    value: function createCursorTrail(x, y) {
      var trails = ['✨', '🔥', '💥', '⭐'];
    ...
    key: "addCoursesHoverEffect",
    value: function addCoursesHoverEffect() {
      var _this6 = this;
      var courseBoxes = document.querySelectorAll('.coursebox');
      courseBoxes.forEach(function (box) {
        box.addEventListener('mouseenter', function (e) {
          _this6.createHoverExplosion(e.currentTarget);
        });
      });
    }
  }, {
    key: "createHoverExplosion",
    value: function createHoverExplosion(element) {
      var emojis = ['✨', '🎃', '⭐', '💫'];
      ...
      var _loop = function _loop(i) {
        setTimeout(function () {
          ...
          requestAnimationFrame(function () {
            spark.style.transform = "translate(".concat(Math.cos(angle) * distance, "px, ").concat(Math.sin(angle) * distance, "px) rotate(360deg)");
    ...
    key: "addHalloweenSounds",
    value: function addHalloweenSounds() {
    ...
    value: function cleanup() {
      ...
      document.querySelectorAll('.halloween-pumpkin, .halloween-ghost, .halloween-bat, .halloween-spider, .halloween-particles, .halloween-fog').forEach(function (el) {
        return el.remove();
      });
    }
  }]);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function openNotification() {
      var dropdownMenu = document.querySelector('ul.dropdown-menu');
      var dropdownItem = document.querySelector('a.dropdown-item h6');
    ...
    key: "hideAdvertisement",
    value: function () {
      var _hideAdvertisement = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var res;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("/user_site_advertisements", {
                method: 'POST',
                headers: {
                  'Content-type': 'application/json; charset=UTF-8'
                }
            ...
            case 6:
              ...
              _context.t0.parse.call(_context.t0, _context.t1);
              $('#anuncio').modal('hide');
            case 9:
            case "end":
              return _context.stop();
      ...
      function hideAdvertisement() {
        return _hideAdvertisement.apply(this, arguments);
      }
      return hideAdvertisement;
    }()
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
...
/* harmony import */ var _campaign_import_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./campaign_import_controller */ "./app/javascript/controllers/campaign_import_controller.js");
/* harmony import */ var _chat_messages_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat_messages_controller */ "./app/javascript/controllers/chat_messages_controller.js");
/* harmony import */ var _discount_search_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./discount_search_controller */ "./app/javascript/controllers/discount_search_controller.js");
/* harmony import */ var _exit_intent_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./exit_intent_controller */ "./app/javascript/controllers/exit_intent_controller.js");
/* harmony import */ var _halloween_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./halloween_controller */ "./app/javascript/controllers/halloween_controller.js");
/* harmony import */ var _home_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./home_controller */ "./app/javascript/controllers/home_controller.js");
/* harmony import */ var _lesson_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lesson_controller */ "./app/javascript/controllers/lesson_controller.js");
/* harmony import */ var _nested_form_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./nested_form_controller */ "./app/javascript/controllers/nested_form_controller.js");
/* harmony import */ var _order_controller__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./order_controller */ "./app/javascript/controllers/order_controller.js");
/* harmony import */ var _payment_controller__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./payment_controller */ "./app/javascript/controllers/payment_controller.js");
/* harmony import */ var _report_user_tag_controller__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./report_user_tag_controller */ "./app/javascript/controllers/report_user_tag_controller.js");
/* harmony import */ var _search_controller__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./search_controller */ "./app/javascript/controllers/search_controller.js");
/* harmony import */ var _sidenav_controller__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./sidenav_controller */ "./app/javascript/controllers/sidenav_controller.js");
/* harmony import */ var _user_controller__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./user_controller */ "./app/javascript/controllers/user_controller.js");
/* harmony import */ var _user_search_controller__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./user_search_controller */ "./app/javascript/controllers/user_search_controller.js");
...
_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("campaign-import", _campaign_import_controller__WEBPACK_IMPORTED_MODULE_1__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("chat-messages", _chat_messages_controller__WEBPACK_IMPORTED_MODULE_2__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("discount-search", _discount_search_controller__WEBPACK_IMPORTED_MODULE_3__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("exit-intent", _exit_intent_controller__WEBPACK_IMPORTED_MODULE_4__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("halloween", _halloween_controller__WEBPACK_IMPORTED_MODULE_5__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("home", _home_controller__WEBPACK_IMPORTED_MODULE_6__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("lesson", _lesson_controller__WEBPACK_IMPORTED_MODULE_7__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("nested-form", _nested_form_controller__WEBPACK_IMPORTED_MODULE_8__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("order", _order_controller__WEBPACK_IMPORTED_MODULE_9__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("payment", _payment_controller__WEBPACK_IMPORTED_MODULE_10__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("report-user-tag", _report_user_tag_controller__WEBPACK_IMPORTED_MODULE_11__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("search", _search_controller__WEBPACK_IMPORTED_MODULE_12__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("sidenav", _sidenav_controller__WEBPACK_IMPORTED_MODULE_13__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("user", _user_controller__WEBPACK_IMPORTED_MODULE_14__["default"]);

_application__WEBPACK_IMPORTED_MODULE_0__["application"].register("user-search", _user_search_controller__WEBPACK_IMPORTED_MODULE_15__["default"]);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      var _this = this;
      this.groupTargets.forEach(function (group) {
        return _this.initializeGroup(group);
      });
    }
  }, {
    key: "addGroup",
    value: function addGroup() {
      ...
      var fragment = this.templateTarget.content.cloneNode(true);
      var group = fragment.querySelector("[data-lesson-target='group']");
      this.initializeGroup(group);
      this.groupsWrapperTarget.appendChild(fragment);
    }
  }, {
    key: "initializeGroup",
    value: function initializeGroup(group) {
      if (!group) return;
      var templatePrefix = group.dataset.templatePrefix;
      var existingId = group.dataset.groupIndex;
      var groupId = existingId && existingId !== "" ? existingId : Date.now().toString();
      group.dataset.groupIndex = groupId;
      var finalPrefix = templatePrefix.replace("TEMPLATE_KEY", groupId);
      console.log(finalPrefix);
      group.querySelectorAll("select, input").forEach(function (element) {
        if (element.name) element.name = element.name.replace(templatePrefix, finalPrefix);
        if (!existingId && element.id) element.id = "".concat(element.id, "_").concat(groupId);
      });
      if (!existingId) {
        group.querySelectorAll("label[for]").forEach(function (label) {
          label.htmlFor = "".concat(label.htmlFor, "_").concat(groupId);
        });
      }
    ...
    key: "configureGroup",
    value: function configureGroup(fragment) {
      var groupId = Date.now().toString();
      var group = fragment.querySelector("[data-lesson-target='group']");
      group.dataset.groupIndex = groupId;
      var templatePrefix = group.dataset.templatePrefix; // ex: "lesson[lesson_womb_component_lectures_attributes][TEMPLATE_KEY]"
      var finalPrefix = templatePrefix.replace("TEMPLATE_KEY", groupId);
      group.querySelectorAll("select, input").forEach(function (element) {
        if (element.name) {
        ...
        if (element.id) {
          element.id = "".concat(element.id, "_").concat(groupId);
        }
      });
      group.querySelectorAll("label[for]").forEach(function (label) {
        label.htmlFor = "".concat(label.htmlFor, "_").concat(groupId);
    ...
    key: "adjustNames",
    value: function adjustNames(fragment) {
      var _this2 = this;
      var groupId = Date.now().toString();
      var group = fragment.querySelector("[data-group-index]");
      if (group) group.dataset.groupIndex = groupId;
      fragment.querySelectorAll("select, input").forEach(function (element) {
        if (element.name) {
          element.name = element.name.replace(/\[\]([^\[]*)$/, "[".concat(groupId, "]$1"));
          element.name = element.name.replace("lesson[", "".concat(_this2.prefixValue, "["));
        }
        if (element.id) {
          element.id = "".concat(element.id, "_").concat(groupId);
        }
      });
      fragment.querySelectorAll("label[for]").forEach(function (label) {
        label.setAttribute("for", "".concat(label.getAttribute("for"), "_").concat(groupId));
      });
    }
  }, {
    key: "removeGroup",
    value: function removeGroup(event) {
      event.preventDefault();
      var group = event.target.closest("[data-lesson-target='group']");
      if (group) group.remove();
    }
  }, {
    key: "loadComponents",
    value: function () {
      var _loadComponents = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var group, wombId, url, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              group = event.target.closest("[data-lesson-target='group']");
              wombId = event.target.value;
              if (group) {
                _context.next = 4;
                break;
              }
            ...
            case 4:
              ...
              this.populateSelect(group.querySelector("[data-lesson-target='componentSelect']"), [], {
                defaultOption: "Selecione uma matriz"
              });
              this.populateSelect(group.querySelector("[data-lesson-target='lectureSelect']"), [], {
                defaultOption: "Selecione um módulo"
              });
              this.renderVideos(group, []);
              return _context.abrupt("return");
            case 9:
              _context.prev = 9;
              url = this.fetchComponentsUrlValue.replace(":womb_id", wombId);
              _context.next = 13;
              return this.fetchJSON(url);
            case 13:
              data = _context.sent;
              this.populateSelect(group.querySelector("[data-lesson-target='componentSelect']"), data, {
                defaultOption: "Selecione um módulo"
              });
              this.populateSelect(group.querySelector("[data-lesson-target='lectureSelect']"), [], {
                defaultOption: "Selecione um módulo"
    ...
    key: "loadLectures",
    value: function () {
      var _loadLectures = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var group, wombSelect, wombId, componentId, url, data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              group = event.target.closest("[data-lesson-target='group']");
              wombSelect = group === null || group === void 0 ? void 0 : group.querySelector("[data-lesson-target='wombSelect']");
              wombId = wombSelect === null || wombSelect === void 0 ? void 0 : wombSelect.value;
              componentId = event.target.value;
              if (!(!group || !wombId || !componentId)) {
                _context2.next = 8;
                break;
              }
              this.populateSelect(group === null || group === void 0 ? void 0 : group.querySelector("[data-lesson-target='lectureSelect']"), [], {
                defaultOption: "Selecione um módulo"
              });
              this.renderVideos(group, []);
            ...
            case 8:
              _context2.prev = 8;
              url = this.fetchLecturesUrlValue.replace(":womb_id", wombId).replace(":component_id", componentId);
              _context2.next = 12;
              return this.fetchJSON(url);
            case 12:
              data = _context2.sent;
              this.populateSelect(group.querySelector("[data-lesson-target='lectureSelect']"), data, {
                defaultOption: "Selecione uma aula"
              });
              this.renderVideos(group, []);
              _context2.next = 20;
              break;
      ...
      function loadLectures(_x2) {
        return _loadLectures.apply(this, arguments);
      }
      return loadLectures;
    }()
  }, {
    key: "loadVideos",
    value: function () {
      var _loadVideos = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
        var _group$querySelector, _group$querySelector2;
        var group, wombId, componentId, lectureId, url, data;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              group = event.target.closest("[data-lesson-target='group']");
              wombId = group === null || group === void 0 || (_group$querySelector = group.querySelector("[data-lesson-target='wombSelect']")) === null || _group$querySelector === void 0 ? void 0 : _group$querySelector.value;
              componentId = group === null || group === void 0 || (_group$querySelector2 = group.querySelector("[data-lesson-target='componentSelect']")) === null || _group$querySelector2 === void 0 ? void 0 : _group$querySelector2.value;
            ...
            case 7:
              _context3.prev = 7;
              url = this.fetchVideosUrlValue.replace(":womb_id", wombId).replace(":component_id", componentId).replace(":lecture_id", lectureId);
              _context3.next = 11;
              return this.fetchJSON(url);
            case 11:
              data = _context3.sent;
      ...
      function loadVideos(_x3) {
        return _loadVideos.apply(this, arguments);
      }
      return loadVideos;
    }()
  }, {
    key: "fetchJSON",
    value: function () {
      var _fetchJSON = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(url) {
        var response;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              throw new Error("Falha ao buscar ".concat(url));
            case 5:
              _context4.next = 7;
              return response.json();
            case 7:
    ...
    key: "populateSelect",
    value: function populateSelect(select, options) {
    ...
    key: "renderVideos",
    value: function renderVideos(group, videos) {
      var _this3 = this;
      if (!group) return;
      var wrapper = group.querySelector("[data-lesson-target='videosWrapper']");
      if (!wrapper) return;
      var groupId = group.dataset.groupIndex;
      var templatePrefix = group.dataset.templatePrefix;
      var finalPrefix = templatePrefix.replace("lesson[", "".concat(this.prefixValue, "[")).replace("TEMPLATE_KEY", groupId);
      if (!videos.length) {
      ...
      videos.forEach(function (video) {
        ...
        var videoId = String(video.id).replace(/"/g, "");
        var input = document.createElement("input");
        input.type = "checkbox";
        input.className = "form-check-input";
        input.value = videoId;
        input.id = "lecture_video_".concat(video.id, "_").concat(groupId);
        if (_this3.prefixValue.includes("review")) {
          input.name = "lesson[lesson_review_womb_component_lectures_attributes][".concat(groupId, "][videos][]");
        } else {
...
_default.targets = ["groupsWrapper", "group", "template", "wombSelect", "componentSelect", "lectureSelect", "videosWrapper"];
_default.values = {
  prefix: String,
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function add(event) {
      event.preventDefault();
      var content = this.templateTarget.innerHTML.trim();
      var newId = "".concat(this.indexValue++);
      var html = content.replace(/NEW_RECORD/g, newId);
    ...
    value: function remove(event) {
      ...
      var item = event.target.closest("[data-nested-form-target='item']");
      if (!item) return;

      // Se tem campo hidden _destroy => marca como "1" e esconde
      var destroyField = item.querySelector("[data-nested-form-target='destroyField']");
      if (destroyField) {
...
_default.targets = ["list", "template", "item", "destroyField"];
_default.values = {
  index: Number
};
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "viacep",
    value: function () {
      var _viacep = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var cep, userId, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              cep = event.target.value;
              userId = document.querySelector("#order_user_id").value;
              if (userId) {
                _context.next = 4;
                break;
              }
      ...
      function viacep(_x) {
        return _viacep.apply(this, arguments);
      }
      return viacep;
    }()
  }, {
    key: "orderDiscount",
    value: function orderDiscount() {
      this.calculoTotal();
    }
  }, {
    key: "addCurso",
    value: function addCurso() {
      var lastDiv = $('.all-cursos div.col-md-4:last');
      var clonedDiv = lastDiv.clone();
      $('.all-cursos').append(clonedDiv);
    }
  }, {
    key: "disabledInstalments",
    value: function disabledInstalments() {
      var method = document.querySelector("#order_payment_method").value;
      if (method == 'card') {
        $(".dados-cartao").show();
      } else {
        $(".dados-cartao").hide();
    ...
    key: "verifyFirstInstallment",
    value: function verifyFirstInstallment() {
      var method = document.querySelector("#order_payment_method").value;
      var installments = document.querySelector("#order_payment_installments").value;
      var first_installment_amount = document.querySelector("#order_first_installment_amount");
      var shouldDisableFirstInstallment = method === "card" || installments === "1" || installments === "" || installments === "recorrente";
    ...
    key: "calculoValorCursos",
    value: function calculoValorCursos() {
      var _this = this;
      var totalValue = 0;
      var fetchPromises = [];
      $(".select-course").each(function (index, element) {
        if (element.value) {
          fetchPromises.push(fetch("/courses/".concat(element.value, ".json"), {
            method: 'GET',
            headers: {
              'Content-type': 'application/json; charset=UTF-8'
            }
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    course = _context2.t0.parse.call(_context2.t0, _context2.t1);
      ...
      Promise.all(fetchPromises).then(function () {
        $(".subtotal").html("R$ ".concat(_this.valor_string(totalValue)));
        $(".total").html("R$ ".concat(_this.valor_string(totalValue)));
        _this.calculoTotal();
      });
    }
  }, {
    key: "calculoTotal",
    value: function calculoTotal() {
      var discount = Number($("#order_discount").val().replace('.', '').replace(',', '.'));
      var subtotal = Number($(".subtotal").html().replace('R$', '').replace('.', '').replace(',', '.'));
      var total = subtotal - discount;
      $(".total").html("R$ ".concat(this.valor_string(total)));
    ...
    key: "parcelas",
    value: function () {
      var _parcelas = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(total) {
        var _this2 = this;
        var res, installments, formatedInstallments;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch("/admin/orders/installments.json?amount=".concat(total), {
                method: 'GET',
                headers: {
                  Accept: 'application/json',
            ...
            case 6:
              ...
              installments = _context3.t0.parse.call(_context3.t0, _context3.t1);
              formatedInstallments = installments.map(function (_ref2) {
                var key = _ref2.key,
                  value = _ref2.value;
                if (key < 7) {
                  return "<option value=\"".concat(key, "\">").concat(key, " x de R$ ").concat(_this2.valor_string(value), "</option>");
      ...
      function parcelas(_x3) {
        return _parcelas.apply(this, arguments);
      }
      return parcelas;
    }()
  }, {
    key: "valor_string",
    value: function valor_string(valor) {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      this.setupMasks();
      this.installmentsCourse = this.readInstallmentsFromHTML();
      this.setupDiscountForm();
      this.exposeSetInstallments();
      this.setupUseAllCashback();
      this.setupFormSubmit();
    }
  }, {
    key: "setupMasks",
    value: function setupMasks() {
    ...
    key: "readInstallmentsFromHTML",
    value: function readInstallmentsFromHTML() {
      // @all_installments é renderizado no HTML em algum lugar;
      // mantemos compatível com a abordagem anterior:
      try {
        // exemplo: data-attribute em algum elemento com id installments_data
        var el = document.getElementById("installments_data");
        if (el && el.dataset.installments) {
          return JSON.parse(el.dataset.installments);
        }
      } catch (e) {
        // fallback: tenta achar variável global criada no inline (se ainda existir)
        if (window.installmentsCourse) return window.installmentsCourse;
      }
      return [];
    }
  }, {
    key: "setupDiscountForm",
    value: function setupDiscountForm() {
      var _this = this;
      var formDiscount = document.getElementById("formDiscount");
      if (!formDiscount || typeof $ === "undefined") return;
      $("#formDiscount").on("submit", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
          var discountApplied, res, discount, installments;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                $("#btnApply").prop("disabled", true);
                e.preventDefault();
                discountApplied = $("#discountApplied").val();
                if (discountApplied) {
                  _context.next = 6;
                  break;
                }
                _this.swalError("Inválido");
                return _context.abrupt("return");
              case 6:
                _context.prev = 6;
                _context.next = 9;
                return fetch("/courses/".concat(formDiscount.dataset.courseId, "/apply_discount.json?discount=").concat(discountApplied), {
                  method: "GET",
                  headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json"
              ...
              case 13:
                _context.t1 = _context.sent;
                discount = _context.t0.parse.call(_context.t0, _context.t1);
                if (!discount.error) {
                  _context.next = 18;
                  break;
                }
                _this.swalError("".concat(discount.error));
                return _context.abrupt("return");
              case 18:
                _this.installmentsCourse = discount.installments;
                installments = _this.installmentsCourse.map(function (_ref2) {
                  var key = _ref2.key,
                    value = _ref2.value;
                  if (key < 7) {
                    return "<option value=\"".concat(key, "\">").concat(key, " x de R$ ").concat(value, "</option>");
                  } else {
                    return "<option value=\"".concat(key, "\">").concat(key, " x de R$ ").concat(value, "*</option>");
                  }
                });
                $("#discount").val(discountApplied);
                $("#installment").html(installments);
                $("#installments").val("");
                $(".price").html("<h2>R$ ".concat(discount.cash, "</h2>"));
                swal("Sucesso", "Desconto Aplicado ao Curso", "success");
                _context.next = 30;
                break;
              case 27:
                _context.prev = 27;
                _context.t2 = _context["catch"](6);
                _this.swalError("Erro ao aplicar desconto");
              case 30:
              case "end":
                return _context.stop();
            }
    ...
    key: "exposeSetInstallments",
    value: function exposeSetInstallments() {
      var _this2 = this;
      // mantém compatibilidade com onchange="setInstallments(this)" no HTML
      window.setInstallments = function (e) {
        var installment = _this2.installmentsCourse.find(function (_ref3) {
          var key = _ref3.key;
          return key == e.value;
        });
        if (!installment) return;
        var priceCourse = parseFloat(installment.value.replace(",", ".")) * installment.key;
        $("#installments").val(e.value);
        $(".price").html("<h2>R$ ".concat(_this2.formatarValorRetornado(priceCourse), "</h2>"));
      };
    }
  }, {
    key: "setupUseAllCashback",
    value: function setupUseAllCashback() {
      var cashbackInput = document.getElementById("cashback_to_use");
      var useAllCashbackBtn = document.getElementById("use_all_cashback");
      if (!cashbackInput || !useAllCashbackBtn) return;
      var maxAttr = cashbackInput.getAttribute("max") || "0";
      var maxNormalized = maxAttr.toString().replace(/\./g, "").replace(",", ".");
      var maxFloat = parseFloat(maxNormalized);
      if (Number.isNaN(maxFloat) || maxFloat < 0) {
        maxFloat = 0;
      }
      useAllCashbackBtn.addEventListener("click", function () {
        cashbackInput.value = maxFloat.toFixed(2).replace(".", ",");
      });
    }
  }, {
    key: "setupFormSubmit",
    value: function setupFormSubmit() {
      var _this3 = this;
      var formPayments = document.querySelector("#payments");
      if (!formPayments) return;
      formPayments.addEventListener("submit", function (e) {
        e.preventDefault();
        if (typeof $ !== "undefined") {
          $(".btn-payment-send").prop("disabled", true);
        }
        var pillsOption = document.querySelector(".nav-link.active");
        if (!pillsOption) {
          _this3.swalError("Selecione uma forma de pagamento");
          return;
        }
        var method = pillsOption.dataset.paymentMethod;
        $("#method").val(method);
        $("#installments").val($("#installment").val());

        // === Cashback ===
        var cashbackInput = document.getElementById("cashback_to_use");
        var cashbackHidden = document.getElementById("cashback_applied_cents");
        if (cashbackInput && cashbackHidden) {
          var raw = cashbackInput.value.trim();
          var normalized = raw.replace(/\./g, "").replace(",", ".");
          var cashbackFloat = parseFloat(normalized);
          if (Number.isNaN(cashbackFloat) || cashbackFloat < 0) {
            cashbackFloat = 0;
          }
          var maxAttr = cashbackInput.getAttribute("max") || "0";
          var maxNormalized = maxAttr.toString().replace(/\./g, "").replace(",", ".");
          ...
          var toUse = Math.min(cashbackFloat, maxFloat);
          var cents = Math.round(toUse * 100);
          cashbackHidden.value = cents;
        }

        // === Cartão de crédito ===
        if (method === "card") {
          var number = $("#cnumber").val().replace(/\s/g, "");
          var name = $("#cname").val();
          var expiry = $("#cexpiry").val();
          var cvc = $("#ccvc").val();
          var _expiry$split = expiry.split("/"),
            _expiry$split2 = _slicedToArray(_expiry$split, 2),
            exp_month = _expiry$split2[0],
            exp_year = _expiry$split2[1];
          if (!number || !name || !expiry || !cvc || !exp_month || !exp_year) {
            _this3.swalError("Tivemos um Problema ao validar seu cartão. Entre em contato com o suporte");
            return;
          }
          $("#credit_card").val(JSON.stringify({
            number: number,
            holder_name: name,
            exp_month: exp_month,
            exp_year: exp_year,
    ...
    key: "formatarValorRetornado",
    value: function formatarValorRetornado(valor) {
      valor = valor.toFixed(2);
      return valor.toString().replace(".", ",");
    }
  }, {
    key: "swalError",
    value: function swalError(error) {
      if (typeof $ !== "undefined") {
        $(".btn-payment-send").prop("disabled", false);
        $("#btnApply").prop("disabled", false);
      }
      if (typeof swal !== "undefined") {
        swal("Atenção!", "".concat(error), "error");
      } else {
        alert(error);
      }
    }
...
/***/ "./app/javascript/controllers/report_user_tag_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/report_user_tag_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function search() {
      var _this2 = this;
      var query = this.inputTarget.value;
      var url = "/admin/help_centers.json?search=".concat(encodeURIComponent(query));
      fetch(url).then(function (response) {
        return response.json();
      }).then(function (data) {
        _this2.renderResults(data);
        if (_this2.hasLoadingTarget) {
          _this2.loadingTarget.style.display = "none";
        }

        // Atualiza a URL
        var newUrl = query ? "/admin/help_centers?search=".concat(encodeURIComponent(query)) : '/admin/help_centers';
    ...
    value: function renderResults(data) {
      ...
      var cardsHtml = data.map(function (helpCenter) {
        return _this3.cardTemplate(helpCenter);
      }).join('');
      this.resultsTarget.innerHTML = cardsHtml;
    }
  }, {
    key: "cardTemplate",
    value: function cardTemplate(helpCenter) {
      return "\n      <div class=\"col-lg-6 col-xl-4 mb-4\">\n        <div class=\"card h-100 hover-shadow\">\n          <div class=\"card-body d-flex flex-column\">\n            <div class=\"d-flex align-items-start mb-3\">\n              <div class=\"icon icon-md bg-gradient-primary shadow text-center border-radius-md me-3\">\n                <i class=\"fas fa-question-circle text-white opacity-10\"></i>\n              </div>\n              <h5 class=\"mb-0 flex-grow-1\">\n                ".concat(helpCenter.title, "\n              </h5>\n            </div>\n            \n            <p class=\"text-sm text-muted mb-4 flex-grow-1\">\n              ").concat(this.formatPreview(helpCenter.content), "\n            </p>\n            \n            <div class=\"mt-auto d-flex gap-2\">\n              <a href=\"/admin/help_centers/").concat(helpCenter.id, "\" class=\"btn btn-sm btn-primary flex-fill\">\n                <i class=\"fas fa-eye me-1\"></i> Ver\n              </a>\n            </div>\n          </div>\n        </div>\n      </div>\n    ");
    }
  }, {
    key: "emptyState",
    ...
    value: function truncate(text) {
      var length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 120;
      ...
      var truncated = cleanText.substring(0, length);

      // Se tem separator, corta na última ocorrência dele
      if (separator) {
        var lastIndex = truncated.lastIndexOf(separator);
        if (lastIndex > 0) {
    ...
    key: "formatPreview",
    value: function formatPreview(content) {
      var length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 120;
      var cleaned = this.stripTags(content);
      return this.truncate(cleaned, length, ' ');
    }
  }]);
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]);
_default.targets = ["input", "results", "loading"];


/***/ }),

/***/ "./app/javascript/controllers/sidenav_controller.js":
/*!**********************************************************!*\
  !*** ./app/javascript/controllers/sidenav_controller.js ***!
  \**********************************************************/
/*! exports provided: default */
  ...
  return _createClass(_default, [{
    ...
    value: function setupEventListeners() {
      ...
      this.html.addEventListener("click", function (e) {
        if (_this.body.classList.contains('g-sidenav-pinned') && !e.target.classList.contains('sidenav-toggler-line')) {
          _this.body.classList.remove(_this.className);
        }
      });
    }
  }, {
    ...
    value: function toggle() {
      ...
      if (this.body.classList.contains(this.className)) {
        ...
        setTimeout(function () {
          _this2.sidenav.classList.remove('bg-white');
        }, 100);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    key: "toggleSenha",
    value: function toggleSenha() {
      var buttonPassword = document.querySelector('.btn-password');
      var senhaInput = buttonPassword.closest('.input-group').querySelector('input');
      var icon = buttonPassword.querySelector('i');
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("/admin/users.json?name=".concat(encodeURIComponent(query)), {
                headers: {
                  'Content-type': 'application/json; charset=UTF-8'
                }
              });
    ...
    value: function displayResults() {
      ...
      var resultsHtml = this.results.map(function (user, index) {
        return "\n      <div class=\"search-result-item p-2 border-bottom\" \n           data-user-id=\"".concat(user.id, "\" \n           data-user-name=\"").concat(user.name, "\"\n           data-user-email=\"").concat(user.email, "\"\n           data-index=\"").concat(index, "\"\n           style=\"cursor: pointer;\">\n        <div class=\"fw-bold\">").concat(user.name, "</div>\n        <div class=\"text-muted small\">").concat(user.email, "</div>\n      </div>\n    ");
      }).join('');
      this.resultsTarget.innerHTML = resultsHtml;
      this.resultsTarget.style.display = 'block';
      this.selectedIndex = -1;
    ...
    key: "getUserData",
    value: function () {
      var _getUserData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId) {
        var response, user;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return fetch("/admin/users/".concat(userId, ".json"), {
                method: 'GET',
                headers: {
                  'Content-type': 'application/json; charset=UTF-8'
                }
    ...
    key: "updateUserForm",
    value: function updateUserForm(user) {
      ...
      if (address) {
        var posta_code = address.posta_code,
...
_default.targets = ["input", "results", "hiddenField"];
...
/* harmony import */ var active_storage_drag_and_drop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! active_storage_drag_and_drop */ "./node_modules/active_storage_drag_and_drop/app/assets/javascripts/active_storage_drag_and_drop.js");
/* harmony import */ var active_storage_drag_and_drop__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(active_storage_drag_and_drop__WEBPACK_IMPORTED_MODULE_3__);
...
active_storage_drag_and_drop__WEBPACK_IMPORTED_MODULE_3___default.a.start();
...
/***/ "./node_modules/active_storage_drag_and_drop/app/assets/javascripts/active_storage_drag_and_drop.js":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/active_storage_drag_and_drop/app/assets/javascripts/active_storage_drag_and_drop.js ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=application-1f3a261e4bc4bb210aac.js.map