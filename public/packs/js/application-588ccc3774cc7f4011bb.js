...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      ...
      if (!this.$) {
        console.warn("jQuery não encontrado (necessário para Bootstrap 4 modal).");
        return;
      }
    ...
    value: function handleVisibilityChange() {
      // Opcional: mostrar quando a aba perde visibilidade
    ...
    value: function showOnce() {
      ...
      var open = function open() {
        return _this.$(_this.element).modal("show");
      };
...
/******/ });
//# sourceMappingURL=application-588ccc3774cc7f4011bb.js.map