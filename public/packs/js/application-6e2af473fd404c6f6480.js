  ...
  return _createClass(_default, [{
    ...
    value: function () {
      var _applyCashbackValue = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var cashbackInput, cashbackValue, cashbackValueFloat, totalAmount, totalAmountFloat, totalAmountWithCashback, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
            ...
            case 9:
              ...
              return _context.abrupt("return");
            case 12:
              if (!(totalAmountWithCashback <= 0)) {
                _context.next = 15;
                break;
              }
              this.swalError("O valor do cashback não pode ser maior que o total da compra");
              return _context.abrupt("return");
            case 15:
              _context.next = 17;
...
/******/ });
//# sourceMappingURL=application-6e2af473fd404c6f6480.js.map