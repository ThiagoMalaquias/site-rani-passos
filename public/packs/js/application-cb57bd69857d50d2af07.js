...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function setValueImutable() {
      var maxCashback = document.getElementById("max_cashback").textContent;
      document.getElementById("total_amount").innerHTML = maxCashback;
      document.getElementById("installments").value = 1;
    }
  }, {
    key: "setupFormSubmit",
...
/******/ });
//# sourceMappingURL=application-cb57bd69857d50d2af07.js.map