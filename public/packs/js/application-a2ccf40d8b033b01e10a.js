...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function addHalloweenDecorations() {
      ...
      // Adiciona abóboras nos cantos
      this.createDecoration('🎃', 'halloween-pumpkin', '20px', '20px');
      this.createDecoration('🎃', 'halloween-pumpkin', '20px', 'auto', '20px');
      this.createDecoration('👻', 'halloween-ghost', 'auto', '20px', '100px');
      this.createDecoration('🦇', 'halloween-bat', '150px', 'auto', '50px');
    }
  }, {
    ...
    value: function addFloatingElements() {
      var _this = this;
      // Adiciona elementos flutuantes aleatórios
    ...
    value: function addHalloweenCursor() {
      // Adiciona trilha de estrelas ao cursor
...
/******/ });
//# sourceMappingURL=application-a2ccf40d8b033b01e10a.js.map